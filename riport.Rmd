...
#Modellválasztásnál először az össze változót belepakoltam, majd logaritmikus és négyzetes változókat kezdtem bepakolni, mert a pontdiagramok alapján lehet, hogy nem lineáris a kapcsolat a változók között.

#Maradéktagok: a valós és a becsült értékek közötti különbség. "Kisebb" jövedelem esetén kisebb a , ami érthető, a megfigyelések fele 48918.2 ezer usd alatti, az átlag viszont 132496.4 ezer usd. A "kis" értékeket felülbecsli. Mintázat is látszik az adatokban, ezt nem sikerült kiszűrni, hiába tettem be újabb változókat egyáltalán nem gyengült.Tehát újabb változók kellenének a bevételek varianciájának magyarázatához. A korrigált R^2 viszont elég magas ~ 0.75. A maradéktagok standard hibája 107.400 (az összes adaton lefutatott regresszióban), ami rendkívül magas, majdnem az átlaggal egyenlő.

#Cross validációt végeztem az "overfitting" elkerülése végett.
#ez alapján revenue_new_1000 ~ . + log(runtime) + log(popularity) + I(popularity^2) + log(vote_average) modell esetében a legkisebb az MSE (a train adatok esetében is igaz ez).
